...
if __name__ == "__main__":
    ...
    send_message_with_file_to_slack("Ellipse Accuracy Plot.", os.path.join('build', 'results', 'AccuracyTable_Ellipse.png'), "Ellipse Accuracy Plot")
    send_message_with_file_to_slack("Flower Accuracy Plot.", os.path.join('build', 'results', 'AccuracyTable_Flower.png'), "Flower Accuracy Plot")
    send_message_with_file_to_slack("Petals Accuracy Plot.", os.path.join('build', 'results', 'AccuracyTable_Petals.png'), "Petals Accuracy Plot")
    send_message_with_file_to_slack("Ghost Accuracy Plot.", os.path.join('build', 'results', 'AccuracyTable_Ghost.png'), "Ghost Accuracy Plot")