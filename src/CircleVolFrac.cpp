...
static inline double section(double h, double r = 1) {
...
static inline double g(double x, double h, double r = 1) {
    double rr = r * r;
    return 0.5 * (sqrt(1.0 - (x * x) / rr) * x * r + rr * asin(x / r) - 2.0 * h * x);
}

static inline double area(double x0, double x1, double h, double r) {
...
static inline double area(double x0, double x1, double y0, double y1, double r)
{
